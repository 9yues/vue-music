  ...
  <div class="player" v-show="playlist.length > 0">
    ...
    <transition name="mini">
      <div class="mini-player" v-show="!fullScreen" @click="open">
        ...
        <div class="control" @click.stop="showPlalist">
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      ...mapGetters([
         // 相当于 this.fullScreen = fullScreen
        'fullScreen',
        'playing',
        'currentIndex',
        'mode',
    ...
    methods: {
      ...
      ...mapMutations({
        // 相当于 this.$store.commit('SET_FULL_SCREEN',?)
